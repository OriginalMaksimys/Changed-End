...
public class CorruptedRootsPriShchielchkiePKMPoRastieniiuProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ChangedEndModBlocks.CORRUPTED_ROOTS.get()) {
			{
