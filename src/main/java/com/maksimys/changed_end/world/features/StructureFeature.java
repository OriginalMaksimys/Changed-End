package com.maksimys.changed_end.world.features;
...
import com.maksimys.changed_end.world.features.configurations.StructureFeatureConfiguration;
import com.maksimys.changed_end.ChangedEndMod;

public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, ChangedEndMod.MODID);
